...
class WeaklySegDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_file, xml_file = self.image_mask_pairs[idx]
        ...
        # Create full mask and point annotations from XML with debug visualization
...
def get_data_loaders(root_dir, batch_size=8, debug_mode=False):
    ...
    train_loader = torch.utils.data.DataLoader(
        train_dataset, batch_size=batch_size, shuffle=not debug_mode, num_workers=4
    )
